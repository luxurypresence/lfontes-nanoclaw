...
description: Force a multiple-choice decision (`ask_user_question`) or display structured content (`send_card`). Use when you need the user to pick an option before continuing, or when prose isn't the right format for what you're presenting (summaries, option lists, results with action buttons).
---
